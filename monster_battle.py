"""
Monster Battle Arena - Game Berbasis OOP
...
class Monster:
    ...
    """
    def __init__(self, name, max_hp, attack_power, element):
...
class FireMonster(Monster):
    ...
    def __init__(self, name="Flameo"):
        super().__init__(name, max_hp=100, attack_power=25, element="Fire")
...
class WaterMonster(Monster):
    ...
    def __init__(self, name="Aqualis"):
        super().__init__(name, max_hp=120, attack_power=20, element="Water")
...
class EarthMonster(Monster):
    ...
    def __init__(self, name="Terrados"):
        super().__init__(name, max_hp=140, attack_power=18, element="Earth")
...
class BattleGame:
    ...
    def enemy_attack(self):
        ...
        # AI sederhana: 30% chance special attack
...
class MonsterBattleGUI:
    """
    GUI Application menggunakan Tkinter
    """
    def __init__(self, root):
        self.root = root
        self.root.title("Monster Battle Arena")
    ...
    def create_menu_screen(self):
        ...
        monster_frame = tk.Frame(self.root, bg="#1a1a2e")
        monster_frame.pack(pady=30)
        ...
        fire_btn.grid(row=0, column=0, padx=10)
        
        # Water Monster Button
        water_btn = tk.Button(
            monster_frame,
            text="💧 WATER\nAqualis\nHP: 120 | ATK: 20",
            font=("Arial", 12, "bold"),
        ...
        earth_btn.grid(row=0, column=2, padx=10)
    ...
    def create_battle_screen(self):
        ...
        player_frame.grid(row=0, column=0, padx=30)
        ...
        tk.Label(
            player_frame,
            text=f"Element: {player.get_element()}",
            font=("Arial", 12),
            bg="#16213e",
            fg="white"
        ).pack()
        ...
        self.player_hp_bar.pack(pady=5, padx=10)
        
        # Enemy info
        enemy_frame = tk.Frame(info_frame, bg="#16213e", relief="raised", borderwidth=3)
        enemy_frame.grid(row=0, column=1, padx=30)
        ...
        tk.Label(
            enemy_frame,
            text=f"Element: {enemy.get_element()}",
            font=("Arial", 12),
            bg="#16213e",
            fg="white"
        ).pack()
        ...
        self.enemy_hp_bar.pack(pady=5, padx=10)
        ...
        self.add_battle_log("Battle Start! Choose your action!")
